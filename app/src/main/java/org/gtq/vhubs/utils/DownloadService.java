...
public class DownloadService extends Service {
    ...
    public void onCreate() {
        super.onCreate();
        notify_name=getString(R.string.current_download);
...
//					mNotification.setLatestEventInfo(mContext, "下载完成", "文件已下载完毕", null);
    ...
    private void setUpNotification() {
        ...
        mNotification = new NotificationCompat.Builder(this)
                .setLargeIcon(BitmapFactory.decodeResource(getResources(), R.mipmap.ic_launcher)).setSmallIcon(R.mipmap.ic_launcher)
                .setContent(contentView).setDefaults(Notification.DEFAULT_ALL)
                .build();

//        mNotification = new Notification(icon, tickerText, when);
//        mNotification.color = getResources().getColor(R.color.main_bg);
        // 放置在"正在运行"栏目中
