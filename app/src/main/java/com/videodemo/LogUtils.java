...
public class LogUtils {
	...
	private final static boolean allowD = false;
	private final static boolean allowE = false;
	private final static boolean allowI = false;
	private final static boolean allowV = false;
	private final static boolean allowW = false;
